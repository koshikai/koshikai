...
echo "3. If you want the MathKB MCP service too, place .env.mathkb in /opt/home"
echo "4. Compose files are synced automatically into the runner user's \$HOME/deploy/koshikai"
echo "---------------------------------------------------"
