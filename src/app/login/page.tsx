        ...
        <div className="w-full max-w-md">
          <div className="rounded-3xl border border-white/10 bg-white/5 p-8 shadow-[0_35px_80px_-55px_rgba(15,23,42,0.9)] backdrop-blur motion-safe:animate-[fadeUp_0.8s_ease-out]">
            <div className="flex items-center justify-between">
              ...
              <span className="text-xs uppercase tracking-[0.3em] text-slate-400">セキュアアクセス</span>
            </div>

            <h2 className="mt-6 text-3xl font-semibold text-white">おかえりなさい</h2>
            <p className="mt-2 text-sm text-slate-300">
              Koshikai コマンドセンターにログインして、クラスタを同期させましょう。
            </p>
