...
import { ArrowLink, ButtonLink, Container, SectionHeader } from "@/components/ui";
...
export default function Home() {
  return (
    <main id="main-content">
      {/* --- Hero --- */}
      <Container>
        <section aria-labelledby="hero-heading" className="grid grid-cols-12 gap-x-6 pb-14 pt-16 sm:pb-20 sm:pt-24">
          <div className="col-span-12 lg:col-span-9">
            ...
            <div className="mt-9 flex flex-wrap gap-3">
              ...
              <ButtonLink href="https://github.com/koshikai">GitHub</ButtonLink>
              <ButtonLink href="/about#contact">Contact</ButtonLink>
            </div>
          </div>
        </section>
        ...
        <nav aria-label="3つの軸">
          <ul role="list" className="grid list-none grid-cols-1 overflow-hidden rounded border border-border md:grid-cols-3">
            {axes.map((axis, i) => (
              <li
                key={axis.keyword}
              ...
              >
                ...
                >
                  ...
                  <span className="mt-1 text-lg font-semibold tracking-tight text-foreground sm:mt-2 sm:text-xl">{axis.section}</span>
                  <span className="mt-1 text-sm leading-[1.8] text-foreground sm:mt-2">{axis.summary}</span>
      ...
      <Container className="mt-24 sm:mt-28">
        <section id="works" aria-labelledby="works-heading">
          ...
          />
          <ul role="list" className="grid list-none grid-cols-1 gap-x-6 gap-y-12 sm:grid-cols-2 lg:grid-cols-3">
