  ...
  return (
    <div className="fixed bottom-6 left-6 z-[9999] flex flex-col items-start gap-3 pointer-events-none select-none">
      ...
      <div className="flex items-center gap-2 rounded-xl bg-zinc-900/90 px-3 py-2 text-[10px] font-black text-white shadow-2xl backdrop-blur-md ring-1 ring-white/10 dark:bg-white/90 dark:text-zinc-900 dark:ring-black/10">
        <Monitor className="h-3 w-3 text-sky-400 dark:text-sky-600" aria-hidden="true" />
      ...
      <div className="flex items-center gap-1 rounded-xl bg-zinc-900/90 p-1 shadow-2xl backdrop-blur-md ring-1 ring-white/10 pointer-events-auto dark:bg-white/90 dark:ring-black/10">
        <button
          ...
          className="rounded-lg px-3 py-1.5 text-[10px] font-black uppercase tracking-wider text-zinc-400 transition-colors hover:text-white focus-visible:ring-2 focus-visible:ring-sky-500 focus-visible:ring-offset-2 dark:text-zinc-500 dark:hover:text-zinc-900"
        >
          Portfolio
        </button>
        ...
        <button
          ...
          className="group flex h-7 w-7 items-center justify-center rounded-lg transition-colors hover:bg-white/10 focus-visible:ring-2 focus-visible:ring-sky-500 focus-visible:ring-offset-2 dark:hover:bg-zinc-900/10"
          title="Reset to Default"
        >
          <RefreshCw className="h-3 w-3 text-zinc-400 transition-transform group-hover:rotate-180 dark:text-zinc-500" aria-hidden="true" />
        </button>
      </div>
    </div>
  );
